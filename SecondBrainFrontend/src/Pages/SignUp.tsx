...
export function SignUp() {
    ...
    async function signup() {
        ...
        await axios.post(BACKEND_URL + "/api/v1/signup", { username, password },{ withCredentials: true });
        ...
        <div className="w-full h-screen flex justify-center items-center bg-gradient-to-r from-blue-200 to-purple-300 px-4">
            <div className="bg-white rounded-lg w-full max-w-4xl flex flex-col md:flex-row shadow-lg">
                ...
                <div className="flex flex-col justify-center items-center w-full md:w-1/2 p-6 md:p-8">
                    ...
                    <div className="text-gray-600 text-xl font-bold mb-4 text-center">Create your account</div>
                    ...
                    <div className="text-gray-500 mt-3 text-sm">
                        <a className="underline" href="/signin">Already have an account? Log in</a>
                    </div>
                </div>
                ...
                <div className="hidden md:flex w-1/2 justify-center items-center p-6">
                    <img className="w-full rounded-lg shadow-md" 
                         src="https://plus.unsplash.com/premium_vector-1736866367473-ecfc664538ad?q=80&w=800&auto=format&fit=crop" 
